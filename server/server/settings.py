...
ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", default="localhost 127.0.0.1 0.0.0.0 [::1]").split(" ")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "ulstu_quiz"),
...
MONGODB_DATABASE = os.environ.get('MONGODB_DATABASE', 'ulstu_quiz')
